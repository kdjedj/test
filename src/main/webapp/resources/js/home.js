		...
		function handleSearchBoxClick() {
			...
			if (searchHistory) {
				...
				for (let i=0; i < searchList.length; i++) {
					...
					li=$('<li>' + '<span class="test">' + region + '</span>' + '<span class="summoner">' + query + '</span>' + '<div class="favorite-summoner-chk">' + '<input type="checkbox" id="fav_' + i +'" class="checkBox">' + '<label for="fav_' + i +' " class="favorite-summoner-list ' + favoriteClass + '"></label>' + '</div>' + '<button type="button" class="close-btn">' + "X" + '</button>' + '</li>');
				...
				bookMarks.on("click", function() {
						...
						if (favorites) {
							...
							for (let i=0; i < favoritesList.length; i++) {
								...
								// 아이템을 생성하고 이벤트를 연결할 때마다 ID를 증가시킴
								var li=$('<li>' + '<span class="test">' + region + '</span>' + '<span class="summoner">' + query + '</span>' + '<button type="button" class="close-btn">' + "X" + '</button>' + '</li>');
							...
							var li=$('<li>' + '<span class="test">즐겨찾기를 등록해보세요</span>' + '<span class="summoner"></span>' + '</li>');
