	...
	<div class="read_container">
		<div class="sideMenu">
			<div id="profileBox">
				...
				<div class="side_btn">
					<button type="button" id="write" title="글쓰기" onclick="location.href='${cp}/board/compWrite'">글쓰기</button>
				</div>
				<div class="side_btn">
		...
		<div class="read">
			...
			<div class="read_actions">
				<div class="read_action">
					<button type="button" class="read-btn" onclick="location.href='${cp}/board/compModify?c_idx=<%=c_idx%>'">수정</button>
